...
@section('content')
<div class="flex flex-col justify-center md:items-center min-h-screen">
    ...
    <div class="w-full h-screen md:h-full md:w-1/2 lg:w-1/3 px-6 py-8 bg-white md:border md:border-gray-200 md:rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <h1 class="text-4xl text-center mb-6 text-white">Register</h1>
        <form class="mx-auto" action="{{ route('register.store') }}" method="POST">
            @csrf
            <div class="mb-5">
            ...
            <div class="flex justify-center">
                <p class="text-white text-sm">Already have account? <a href="{{ route('login.index') }}" class="text-blue-500 hover:text-blue-600">Login</a></p>
            </div>
        </form>
    </div>
</div>
